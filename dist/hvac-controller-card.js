const t=globalThis,e=t.ShadowRoot&&(void 0===t.ShadyCSS||t.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),s=new WeakMap;let r=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const i=this.t;if(e&&void 0===t){const e=void 0!==i&&1===i.length;e&&(t=s.get(i)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),e&&s.set(i,t))}return t}toString(){return this.cssText}};const o=(t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new r(s,t,i)},a=e?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new r("string"==typeof t?t:t+"",void 0,i))(e)})(t):t,{is:n,defineProperty:l,getOwnPropertyDescriptor:d,getOwnPropertyNames:c,getOwnPropertySymbols:h,getPrototypeOf:p}=Object,f=globalThis,x=f.trustedTypes,y=x?x.emptyScript:"",u=f.reactiveElementPolyfillSupport,g=(t,e)=>t,m={toAttribute(t,e){switch(e){case Boolean:t=t?y:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},$=(t,e)=>!n(t,e),w={attribute:!0,type:String,converter:m,reflect:!1,useDefault:!1,hasChanged:$};Symbol.metadata??=Symbol("metadata"),f.litPropertyMetadata??=new WeakMap;let _=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=w){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&l(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){const{get:s,set:r}=d(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:s,set(e){const o=s?.call(this);r?.call(this,e),this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??w}static _$Ei(){if(this.hasOwnProperty(g("elementProperties")))return;const t=p(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(g("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(g("properties"))){const t=this.properties,e=[...c(t),...h(t)];for(const i of e)this.createProperty(i,t[i])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(const[t,e]of this.elementProperties){const i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(a(t))}else void 0!==t&&e.push(a(t));return e}static _$Eu(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((i,s)=>{if(e)i.adoptedStyleSheets=s.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const e of s){const s=document.createElement("style"),r=t.litNonce;void 0!==r&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}})(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){const r=(void 0!==i.converter?.toAttribute?i.converter:m).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){const i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){const t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:m;this._$Em=s;const o=r.fromAttribute(e,t.type);this[s]=o??this._$Ej?.get(s)??o,this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){const o=this.constructor;if(!1===s&&(r=this[t]),i??=o.getPropertyOptions(t),!((i.hasChanged??$)(r,e)||i.useDefault&&i.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,i))))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:r},o){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??e??this[t]),!0!==r||void 0!==o)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),!0===s&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,i]of t){const{wrapped:t}=i,s=this[e];!0!==t||this._$AL.has(e)||void 0===s||this.C(e,void 0,i,s)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(t){}firstUpdated(t){}};_.elementStyles=[],_.shadowRootOptions={mode:"open"},_[g("elementProperties")]=new Map,_[g("finalized")]=new Map,u?.({ReactiveElement:_}),(f.reactiveElementVersions??=[]).push("2.1.2");const k=globalThis,b=t=>t,v=k.trustedTypes,A=v?v.createPolicy("lit-html",{createHTML:t=>t}):void 0,z="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,S="?"+E,C=`<${S}>`,M=document,P=()=>M.createComment(""),N=t=>null===t||"object"!=typeof t&&"function"!=typeof t,I=Array.isArray,L="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,D=/-->/g,O=/>/g,U=RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),G=/'/g,T=/"/g,H=/^(?:script|style|textarea|title)$/i,B=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),j=B(1),V=B(2),W=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),F=new WeakMap,q=M.createTreeWalker(M,129);function Z(t,e){if(!I(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(e):e}const Y=(t,e)=>{const i=t.length-1,s=[];let r,o=2===e?"<svg>":3===e?"<math>":"",a=R;for(let e=0;e<i;e++){const i=t[e];let n,l,d=-1,c=0;for(;c<i.length&&(a.lastIndex=c,l=a.exec(i),null!==l);)c=a.lastIndex,a===R?"!--"===l[1]?a=D:void 0!==l[1]?a=O:void 0!==l[2]?(H.test(l[2])&&(r=RegExp("</"+l[2],"g")),a=U):void 0!==l[3]&&(a=U):a===U?">"===l[0]?(a=r??R,d=-1):void 0===l[1]?d=-2:(d=a.lastIndex-l[2].length,n=l[1],a=void 0===l[3]?U:'"'===l[3]?T:G):a===T||a===G?a=U:a===D||a===O?a=R:(a=U,r=void 0);const h=a===U&&t[e+1].startsWith("/>")?" ":"";o+=a===R?i+C:d>=0?(s.push(n),i.slice(0,d)+z+i.slice(d)+E+h):i+E+(-2===d?e:h)}return[Z(t,o+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class J{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,o=0;const a=t.length-1,n=this.parts,[l,d]=Y(t,e);if(this.el=J.createElement(l,i),q.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=q.nextNode())&&n.length<a;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(z)){const e=d[o++],i=s.getAttribute(t).split(E),a=/([.?@])?(.*)/.exec(e);n.push({type:1,index:r,name:a[2],strings:i,ctor:"."===a[1]?it:"?"===a[1]?st:"@"===a[1]?rt:et}),s.removeAttribute(t)}else t.startsWith(E)&&(n.push({type:6,index:r}),s.removeAttribute(t));if(H.test(s.tagName)){const t=s.textContent.split(E),e=t.length-1;if(e>0){s.textContent=v?v.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],P()),q.nextNode(),n.push({type:2,index:++r});s.append(t[e],P())}}}else if(8===s.nodeType)if(s.data===S)n.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(E,t+1));)n.push({type:7,index:r}),t+=E.length-1}r++}}static createElement(t,e){const i=M.createElement("template");return i.innerHTML=t,i}}function Q(t,e,i=t,s){if(e===W)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl;const o=N(e)?void 0:e._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),void 0===o?r=void 0:(r=new o(t),r._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=Q(t,r._$AS(t,e.values),r,s)),e}class X{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??M).importNode(e,!0);q.currentNode=s;let r=q.nextNode(),o=0,a=0,n=i[0];for(;void 0!==n;){if(o===n.index){let e;2===n.type?e=new tt(r,r.nextSibling,this,t):1===n.type?e=new n.ctor(r,n.name,n.strings,this,t):6===n.type&&(e=new ot(r,this,t)),this._$AV.push(e),n=i[++a]}o!==n?.index&&(r=q.nextNode(),o++)}return q.currentNode=M,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class tt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),N(t)?t===K||null==t||""===t?(this._$AH!==K&&this._$AR(),this._$AH=K):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>I(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==K&&N(this._$AH)?this._$AA.nextSibling.data=t:this.T(M.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=J.createElement(Z(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new X(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=F.get(t.strings);return void 0===e&&F.set(t.strings,e=new J(t)),e}k(t){I(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const r of t)s===e.length?e.push(i=new tt(this.O(P()),this.O(P()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=b(t).nextSibling;b(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}let et=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=K,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=K}_$AI(t,e=this,i,s){const r=this.strings;let o=!1;if(void 0===r)t=Q(this,t,e,0),o=!N(t)||t!==this._$AH&&t!==W,o&&(this._$AH=t);else{const s=t;let a,n;for(t=r[0],a=0;a<r.length-1;a++)n=Q(this,s[i+a],e,a),n===W&&(n=this._$AH[a]),o||=!N(n)||n!==this._$AH[a],n===K?t=K:t!==K&&(t+=(n??"")+r[a+1]),this._$AH[a]=n}o&&!s&&this.j(t)}j(t){t===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};class it extends et{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===K?void 0:t}}class st extends et{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==K)}}class rt extends et{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??K)===W)return;const i=this._$AH,s=t===K&&i!==K||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==K&&(i===K||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ot{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const at=k.litHtmlPolyfillSupport;at?.(J,tt),(k.litHtmlVersions??=[]).push("3.3.3");const nt=globalThis;class lt extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new tt(e.insertBefore(P(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}lt._$litElement$=!0,lt.finalized=!0,nt.litElementHydrateSupport?.({LitElement:lt});const dt=nt.litElementPolyfillSupport;dt?.({LitElement:lt}),(nt.litElementVersions??=[]).push("4.2.2");const ct={energy_total:/metertotal$|_energy_total$|_kwh_total$/,power_total:/3phase_active_power$|_active_power$|_power_total$/,power_l1:/active_power_p1$/,power_l2:/active_power_p2$/,power_l3:/active_power_p3$/,volts_l1:/phase_1_v$|_l1_n$|_voltage_l1$/,volts_l2:/phase_2_v$|_l2_n$|_voltage_l2$/,volts_l3:/phase_3_v$|_l3_n$|_voltage_l3$/,current_l1:/phase_1_a$|_current_l1$/,current_l2:/phase_2_a$|_current_l2$/,current_l3:/phase_3_a$|_current_l3$/,power_factor:/power_factor$/,frequency:/frequency$/,volume_total:/_cubicmetre$|_volume_total$|_water_total$|watermeter_total$/},ht=new Set(["unavailable","unknown","none",""]),pt={volts_avg:["volts_l1","volts_l2","volts_l3"],current_avg:["current_l1","current_l2","current_l3"]};function ft(t,e){if(!e)return{dark:!0,stale:!1};const i=t.states[e];if(!i)return{entityId:e,dark:!0,stale:!1};const s=String(i.state);if(ht.has(s.toLowerCase()))return{entityId:e,state:s,dark:!0,stale:!0};const r=Number(s);return{entityId:e,state:s,value:Number.isFinite(r)?r:void 0,unit:i.attributes.unit_of_measurement,dark:!1,stale:!1}}function xt(t,e,i){const s=t.states[e];if(!s)return{entityId:e,dark:!0,stale:!1};if(ht.has(String(s.state).toLowerCase()))return{entityId:e,state:s.state,dark:!0,stale:!0};const r=s.attributes,o=(t,i)=>{if(null==t)return{entityId:e,dark:!0,stale:!1};const s=Number(t);return{entityId:e,state:String(t),value:Number.isFinite(s)?s:void 0,unit:i,dark:!1,stale:!1}};switch(i){case"hvac_mode":return o(s.state);case"hvac_action":return o(r.hvac_action??s.state);case"setpoint":return o(r.temperature,"°C");case"room_temp":return o(r.current_temperature,"°C");case"fan_speed":return o(r.fan_mode);case"swing":return o(r.swing_mode);case"power":return o("off"===s.state?"off":"on");case"humidity":return o(r.current_humidity,"%");default:return{entityId:e,dark:!0,stale:!1}}}function yt(t){const[e,i]=t.faceplate.size,s=(r=t.faceplate,o=t.page,r.regions.filter(t=>!t.page||t.page===o));var r,o;return j`
    ...
    <text
      ...
      text-anchor=${s}
    >${i}</text>
  `}(e,i);case"lamp":return function(t,e){const i=!e.dark&&void 0!==e.state&&!["off","0","false","normal","ok"].includes(e.state.toLowerCase()),s=(t.w??12)/2;return V`
    <circle
      class="lamp ${i?"lit":""}"
      cx=${t.x+s}
      cy=${t.y+s}
    ...
    />
    ${t.label?V`<text class="lamp-label" x=${t.x+s} y=${t.y+2*s+12}
              text-anchor="middle">${t.label}</text>`:""}
  `}(e,i);case"bar":return function(t,e){const i=t.w??100,s=t.h??10,r=t.max??100,o=e.dark||void 0===e.value?0:Math.max(0,Math.min(1,e.value/r));return V`
    ...
    <rect
      ...
      rx="2"
    />
  `}(e,i);case"ring":return function(t,e){const i=(e.state??"").toLowerCase(),s=!e.dark&&"off"!==i&&"0"!==i&&"false"!==i;return V`
    <circle
      class="ring ${s?"lit":""}"
      cx=${t.x}
      cy=${t.y}
    ...
    />
  `}(e,i);case"odometer":return function(t,e){const i=t.digits??5,s=t.redDigits??1,r=t.scale??1,o=(t.w??140)/i,a=t.h??34,n=e.dark||void 0===e.value?"-".repeat(i):String(Math.floor(Math.abs(e.value)/r)).slice(-i).padStart(i,"0");return V`
    <g class="odometer ${e.dark?"dark":""}">
      ${[...n].map((e,r)=>{const n=r>=i-s;return V`
          <rect
  ...
  `}(e,i);case"needle":return function(t,e){const i=t.r??26,s=t.scale??1,r=e.dark||void 0===e.value?0:Math.abs(e.value)/s%10/10,o=2*r*Math.PI-Math.PI/2,a=t.x+Math.cos(o)*(i-5),n=t.y+Math.sin(o)*(i-5);return V`
    <g class="dial ${e.dark?"dark":""}">
      <circle class="dial-face" cx=${t.x} cy=${t.y} r=${i} />
      ${[...Array(10).keys()].map(e=>{const s=e/10*2*Math.PI-Math.PI/2;return V`<line
          class="dial-tick"
          ...
          y2=${t.y+Math.sin(s)*i}
        />`})}
      <line class="dial-needle" x1=${t.x} y1=${t.y} x2=${a} y2=${n} />
      <circle class="dial-hub" cx=${t.x} cy=${t.y} r="2.4" />
      ${t.label?V`<text class="dial-label" x=${t.x} y=${t.y+i+13}
                text-anchor="middle">${t.label}</text>`:""}
    </g>
  `}(e,i);case"button":return function(t,e){const i=e.w??44,s=e.h??26;return V`
  ...
  `}const ut=400,gt=400,mt=62,$t=84,wt=276,_t=244,kt=[142,188,234,280],bt=352,vt=[112,172,232,292],At=V`
  <defs>
...
`,regions:[{id:"etot",role:"energy_total",kind:"text",x:34,y:34,w:390,label:"Total energy",unit:"kWh",decimals:1,size:40},{id:"ptot",role:"power_total",kind:"text",x:34,y:124,w:180,label:"Power",unit:"kW",decimals:2,size:28},{id:"pf",role:"power_factor",kind:"text",x:250,y:124,w:174,label:"Power factor",decimals:2,size:28},{id:"v1",role:"volts_l1",kind:"text",x:34,y:200,w:120,label:"L1-N",unit:"V",decimals:0,size:22},{id:"v2",role:"volts_l2",kind:"text",x:174,y:200,w:120,label:"L2-N",unit:"V",decimals:0,size:22},{id:"v3",role:"volts_l3",kind:"text",x:314,y:200,w:110,label:"L3-N",unit:"V",decimals:0,size:22}]},Mt=230,Pt=380,Nt=V`
  ...
  ${[0,1,2,3].map(t=>V`<rect x="${26+45*t}" y="4" width="34" height="20" rx="2" fill="#23282d" />`)}
  ${[0,1,2,3].map(t=>V`<rect x="${26+45*t}" y="${354}" width="34" height="20" rx="2" fill="#23282d" />`)}
...
`,pages:["power","volts","amps","energy"],regions:[{id:"p-w",role:"power_total",kind:"text",page:"power",x:70,y:66,w:232,align:"end",unit:"",decimals:2,size:42},{id:"p-va",role:"apparent_power",kind:"text",page:"power",x:70,y:124,w:232,align:"end",decimals:2,size:42},{id:"p-var",role:"reactive_power",kind:"text",page:"power",x:70,y:180,w:232,align:"end",decimals:2,size:42},{id:"v1",role:"volts_l1",kind:"text",page:"volts",x:70,y:66,w:232,align:"end",decimals:1,size:42},{id:"v2",role:"volts_l2",kind:"text",page:"volts",x:70,y:124,w:232,align:"end",decimals:1,size:42},{id:"v3",role:"volts_l3",kind:"text",page:"volts",x:70,y:180,w:232,align:"end",decimals:1,size:42},{id:"a1",role:"current_l1",kind:"text",page:"amps",x:70,y:66,w:232,align:"end",decimals:2,size:42},{id:"a2",role:"current_l2",kind:"text",page:"amps",x:70,y:124,w:232,align:"end",decimals:2,size:42},{id:"a3",role:"current_l3",kind:"text",page:"amps",x:70,y:180,w:232,align:"end",decimals:2,size:42},{id:"e-tot",role:"energy_total",kind:"text",page:"energy",x:70,y:82,w:232,align:"end",decimals:1,size:44},{id:"e-pf",role:"power_factor",kind:"text",page:"energy",x:70,y:160,w:232,align:"end",decimals:2,size:36},{id:"k-prev",role:"",kind:"button",x:86,y:272,w:40,h:40,text:"‹",action:"prev_page"},{id:"k-menu",role:"",kind:"button",x:146,y:274,w:108,h:36,text:"☰",action:"next_page"},{id:"k-next",role:"",kind:"button",x:274,y:272,w:40,h:40,text:"›",action:"next_page"}]},Dt=200,Ot=200,Ut=V`
  ...
  <!-- Brass housing -->
  <circle cx="${Dt}" cy="${Ot}" r="192" fill="url(#mj-brass)" />
  <circle cx="${Dt}" cy="${Ot}" r="192" fill="none" stroke="#8a7133" stroke-width="2" />
  <circle cx="${Dt}" cy="${Ot}" r="176" fill="none" stroke="#8a7133" stroke-width="1.2" />

  <!-- Knurling around the bezel -->
  <g stroke="#9c8138" stroke-width="1.6">
    ${[...Array(60).keys()].map(t=>{const e=t/60*Math.PI*2;return V`<line
        x1="${Dt+178*Math.cos(e)}" y1="${Ot+178*Math.sin(e)}"
        x2="${Dt+190*Math.cos(e)}" y2="${Ot+190*Math.sin(e)}" />`})}
  </g>

  <!-- Dial face -->
  <circle cx="${Dt}" cy="${Ot}" r="170" fill="url(#mj-face)" />

  <text class="mj-brand" x="${Dt}" y="78" text-anchor="middle">MEASURED AUTOMATION</text>
...
`,Gt={id:"multijet-water-register",name:"Multi-jet water register",description:"Mechanical register: five-digit odometer with an x100 multiplier over four sweep dials. Reads in US gallons.",emulates:"Multi-jet mechanical water meter register",card:"bms-meter-card",render:"svg",display:"positive",size:[400,400],artNode:Ut,regions:[{id:"odo",role:"volume_total",kind:"odometer",x:116,y:114,w:168,h:32,digits:5,redDigits:1,scale:100},{id:"units",role:"volume_total",kind:"text",show:"unit",x:100,y:160,w:200,align:"middle",size:14,text:"UNITS"},{id:"mult",role:"",kind:"text",text:"x100",x:296,y:118,w:48,align:"start",size:15},...[{id:"d10",x:104,scale:10,label:"x10"},{id:"d1",x:168,scale:1,label:"x1"},{id:"d01",x:232,scale:.1,label:"x0.1"},{id:"d001",x:296,scale:.01,label:"x0.01"}].map(t=>({id:t.id,role:"volume_total",kind:"needle",x:t.x,y:286,r:27,scale:t.scale,label:t.label}))]},Tt=180,Ht=208,Bt={id:"daikin-brc1h63k",name:"Daikin BRC1H63K (Madoka)",description:"Round wall controller with an illuminated status ring and a dark display. Mode, room temperature and three touch keys.",emulates:"Daikin BRC1H63K Madoka",card:"hvac-controller-card",render:"svg",display:"negative",size:[360,400],artNode:V`
  ...
  <!-- Round face -->
  <circle cx="${Tt}" cy="${Ht}" r="${132}" fill="url(#madoka-face)" />
  <circle cx="${Tt}" cy="${Ht}" r="${122}" fill="none"
          stroke="#0a0d11" stroke-width="2" />

  <!-- Specular highlight, so the glass reads as glass -->
  <ellipse cx="${146}" cy="${134}" rx="62" ry="26"
           fill="#ffffff" opacity="0.06" />
`,regions:[{id:"ring",role:"hvac_mode",kind:"ring",x:Tt,y:Ht,r:128,stroke:7,on:"#2f8fff",off:"#161b21"},{id:"mode",role:"hvac_mode",kind:"text",x:90,y:130,w:180,align:"middle",size:19},{id:"roomlabel",role:"",kind:"text",text:"Room",x:88,y:164,w:70,align:"start",size:15},{id:"temp",role:"room_temp",kind:"text",x:84,y:182,w:172,align:"middle",unit:"",decimals:0,size:68},{id:"unit",role:"",kind:"text",text:"°C",x:258,y:190,w:34,align:"start",size:20},{id:"fan",role:"fan_speed",kind:"text",x:84,y:214,w:80,align:"start",size:14,placeholder:""},{id:"swing",role:"swing",kind:"text",x:84,y:234,w:80,align:"start",size:14,placeholder:""},{id:"sp",role:"setpoint",kind:"text",x:186,y:214,w:90,align:"end",label:"Set",decimals:0,size:18},{id:"minus",role:"",kind:"button",x:106,y:270,w:44,h:34,text:"−",action:"temp_down"},{id:"power",role:"",kind:"button",x:158,y:270,w:44,h:34,text:"○",action:"power_toggle"},{id:"plus",role:"",kind:"button",x:210,y:270,w:44,h:34,text:"+",action:"temp_up"}]},jt=400,Vt=66,Wt=84,Kt=268,Ft=170,qt=118,Zt=252,Yt=188,Jt=200,Qt=296,Xt=96,te=30,ee={id:"daikin-brc1e63",name:"Daikin BRC1E63",description:"Wired navigation controller: landscape LCD with mode, clock, set point and room temperature, over four pill keys and a navigation pad.",emulates:"Daikin BRC1E63 / BRC1E53 navigation remote controller",card:"hvac-controller-card",render:"svg",display:"positive",size:[jt,400],artNode:V`
  <defs>
  ...
  <rect x="0" y="0" width="${jt}" height="${400}" rx="16" fill="url(#brc-bezel)" />
  ...
  <rect x="${62}" y="${80}" width="${276}" height="${132}" rx="3"
        fill="#b3b8ac" />
  <rect x="${Vt}" y="${Wt}" width="${Kt}" height="${124}" fill="url(#brc-lcd)" />
  ...
  <line x1="${Vt}" y1="${Yt}" x2="${334}" y2="${Yt}" stroke="#8d9788" stroke-width="1.5" />
...
`,regions:[{id:"mode",role:"hvac_mode",kind:"text",x:76,y:92,w:88,align:"start",size:22},{id:"fan",role:"fan_speed",kind:"text",x:92,y:142,w:24,align:"start",size:13,placeholder:""},{id:"clock",role:"clock",kind:"text",x:Ft,y:88,w:164,align:"middle",size:22},{id:"sp-label",role:"",kind:"text",text:"Set temp",x:174,y:120,w:74,align:"start",size:11},{id:"sp",role:"setpoint",kind:"text",x:174,y:136,w:74,align:"middle",unit:"°C",decimals:0,size:26},{id:"room-label",role:"",kind:"text",text:"Room",x:256,y:120,w:74,align:"start",size:11},{id:"room",role:"room_temp",kind:"text",x:256,y:136,w:74,align:"middle",unit:"°C",decimals:0,size:26},{id:"status",role:"hvac_action",kind:"text",x:74,y:189,w:252,align:"start",size:12,placeholder:""},{id:"k-mode",role:"",kind:"button",x:46,y:228,w:Xt,h:te,text:"",action:"mode_cycle"},{id:"k-power",role:"",kind:"button",x:258,y:228,w:Xt,h:te,text:"",action:"power_toggle"},{id:"k-fan",role:"",kind:"button",x:46,y:332,w:Xt,h:te,text:"",action:"fan_cycle"},{id:"k-up",role:"",kind:"button",x:178,y:238,w:44,h:30,text:"",action:"temp_up"},{id:"k-down",role:"",kind:"button",x:178,y:324,w:44,h:30,text:"",action:"temp_down"}]},ie=30,se=92,re=V`
  ...
  <!-- Ventilation slots -->
  <g fill="#cfcabd">
    ${[0,1,2,3,4,5].map(t=>V`<rect x="${34+9*t}" y="26" width="4" height="22" rx="2" />`)}
  </g>
  <!-- Wordmark -->
  ...
  <g transform="translate(${74} ${144})">
    ...
    ${[0,3,6,9,12,15,18,21].map(t=>{const e=t/24*Math.PI*2-Math.PI/2,i=37*Math.cos(e),s=37*Math.sin(e)+3;return V`<text class="brc315-ring" x="${i}" y="${s}" text-anchor="middle">${t}</text>`})}
...
`,oe=168,ae=132,ne=132,le=136,de=[Rt,Et,It,Ct,Gt,ee,{id:"daikin-brc2e61",name:"Daikin BRC2E61",description:"Simplified wired controller: a small central display surrounded by large flat keys for power, temperature, fan and louvre.",emulates:"Daikin BRC2E61 simplified remote controller",card:"hvac-controller-card",render:"svg",display:"positive",size:[400,400],artNode:V`
  <defs>
  ...
  <rect x="${116}" y="${116}" width="${oe}" height="${oe}" rx="16"
        fill="url(#brc2-sur)" />
  <rect x="${ae}" y="${ne}" width="${le}" height="${136}" rx="2"
...
`,regions:[{id:"mode",role:"hvac_mode",kind:"text",x:138,y:138,w:124,align:"middle",size:15},{id:"sp",role:"setpoint",kind:"text",x:138,y:214,w:70,align:"start",unit:"",decimals:0,size:32},{id:"spunit",role:"",kind:"text",text:"°C",x:192,y:228,w:20,align:"start",size:12},{id:"fan",role:"fan_speed",kind:"text",x:210,y:222,w:52,align:"end",size:13,placeholder:""},{id:"room",role:"room_temp",kind:"text",x:138,y:252,w:124,align:"middle",label:"",unit:"°C",decimals:0,size:13},{id:"k-power",role:"",kind:"button",x:160,y:24,w:80,h:76,text:"",action:"power_toggle"},{id:"k-up",role:"",kind:"button",x:296,y:30,w:86,h:78,text:"",action:"temp_up"},{id:"k-down",role:"",kind:"button",x:296,y:296,w:86,h:78,text:"",action:"temp_down"},{id:"k-mode",role:"",kind:"button",x:20,y:30,w:86,h:78,text:"",action:"mode_cycle"},{id:"k-fan",role:"",kind:"button",x:20,y:296,w:86,h:78,text:"",action:"fan_cycle"}]},Bt,{id:"daikin-brc315d7",name:"Daikin BRC315D7",description:"Schedule controller, cover closed: wide segmented display with timer rows, temperature and mode icons.",emulates:"Daikin BRC315D7 schedule remote controller",card:"hvac-controller-card",render:"svg",display:"positive",size:[400,400],artNode:re,regions:[{id:"hdr",role:"",kind:"text",text:"ONETIME  DAILY  TIMER",x:114,y:94,w:160,align:"start",size:10},{id:"t1",role:"",kind:"text",text:"--:--",x:122,y:114,w:108,align:"middle",size:22},{id:"t2",role:"",kind:"text",text:"--:--",x:122,y:150,w:108,align:"middle",size:22},{id:"sp",role:"setpoint",kind:"text",x:244,y:106,w:64,align:"middle",unit:"",decimals:0,size:38},{id:"spunit",role:"",kind:"text",text:"°C",x:306,y:130,w:20,align:"start",size:12},{id:"room",role:"room_temp",kind:"text",x:244,y:154,w:64,align:"middle",label:"",decimals:0,size:16},{id:"mode",role:"hvac_mode",kind:"text",x:244,y:172,w:120,align:"start",size:11},{id:"k-power",role:"",kind:"button",x:290,y:56,w:72,h:20,text:"",action:"power_toggle"}]}];function ce(t){return de.filter(e=>e.card===t)}function he(t,e){const i=ce(t);return i.find(t=>t.id===e)??i[0]}const pe="hvac-controller-card",fe=["off","cool","heat","dry","fan_only","auto"];class xe extends lt{setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}getCardSize(){return 5}static getConfigElement(){return document.createElement(`${pe}-editor`)}static getStubConfig(){return{type:`custom:${pe}`,faceplate:"daikin-brc1e63"}}_faceplate(){return he(pe,this._config?.faceplate)}_setpoint(){if(!this.hass||!this._config)return;if(this._config.climate)return xt(this.hass,this._config.climate,"setpoint").value;const t=this._config.entities?.setpoint;return t?Number(this.hass.states[t]?.state):void 0}async _onAction(t){if(!this.hass||!this._config)return;const e=this._config.climate;if(!e)return void this._notify("This controller is read-only — no climate entity is set.");const i=this._setpoint();switch(t.action){case"temp_up":case"temp_down":{if(void 0===i)return;const s="temp_up"===t.action?.5:-.5;return void await this.hass.callService("climate","set_temperature",{entity_id:e,temperature:Math.round(2*(i+s))/2})}case"power_toggle":{const t="off"!==this.hass.states[e]?.state;return void await this.hass.callService("climate",t?"turn_off":"turn_on",{entity_id:e})}case"fan_cycle":{const t=this.hass.states[e]?.attributes.fan_modes??[];if(!t.length)return;const i=this.hass.states[e]?.attributes.fan_mode,s=t[(t.indexOf(i)+1)%t.length];return void await this.hass.callService("climate","set_fan_mode",{entity_id:e,fan_mode:s})}case"mode_cycle":{const t=this.hass.states[e]?.attributes.hvac_modes??fe,i=this.hass.states[e]?.state??t[0],s=t[(t.indexOf(i)+1)%t.length];return void await this.hass.callService("climate","set_hvac_mode",{entity_id:e,hvac_mode:s})}default:return}}_notify(t){this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:t},bubbles:!0,composed:!0}))}render(){if(!this._config||!this.hass)return K;const t=this._faceplate(),e=[...new Set(t.regions.map(t=>t.role))].filter(Boolean),i=function(t,e,i={},s=[]){const r={};for(const o of e){if(i[o]){r[o]=i[o];continue}const e=s.length?s:Object.keys(t.states),a=ct[o];if(!a)continue;const n=e.find(t=>a.test(t));n&&(r[o]=n)}return r}(this.hass,e,this._config.entities??{});return j`
  ...
  `;class ye extends lt{setConfig(t){this._config=t}_emit(t){const e={...this._config,...t};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){if(!this._config||!this.hass)return K;const t=ce(pe),e=he(pe,this._config.faceplate),i=Object.keys(this.hass.states).filter(t=>t.startsWith("climate.")).sort();return j`
      <div class="editor">
        <label>
          Controller
          <select @change=${t=>this._emit({faceplate:t.target.value})}>
            ${t.map(t=>j`<option value=${t.id} ?selected=${t.id===e.id}>
                ${t.name}
              </option>`)}
          </select>
        </label>
        ...
        <label>
          ...
          <select @change=${t=>this._emit({climate:t.target.value})}>
            ...
            ${i.map(t=>j`<option value=${t} ?selected=${t===this._config?.climate}>
                ${t}
              </option>`)}
          </select>
        </label>
        ${i.length?K:j`<p class="warn">
              No climate entities exist on this system. Without one the
              controller is read-only, and its readings must be mapped
              per-role in YAML.
            </p>`}
        ${e.emulates?j`<p class="note">Emulates ${e.emulates}. Product names
              and marks belong to their respective owners.</p>`:K}
      </div>
    `}}ye.properties={hass:{attribute:!1},_config:{state:!0}},ye.styles=o`
    .editor {
      display: flex;
  ...
  `,customElements.define(pe,xe),customElements.define(`${pe}-editor`,ye),window.customCards??=[],window.customCards.push({type:pe,name:"HVAC Controller Card",description:"A wall controller that looks and behaves like the real one.",preview:!0,documentationURL:"https://github.com/rellis-erigon/HA-Cards"});
